...
if(isset($_POST['submit'])){
    ...
    if(count($error) == 0){
        ...
        $qry = "SELECT * FROM `users` WHERE `email` = '$email' AND `role` = 4";
    ...
    $query = "INSERT INTO `users` (`name`,`email`,`password`,`contact`,`address`,`role`) VALUES ('$name','$email','$pass','$phone','$address','4')";
    $result = mysqli_query($connect,$query);
    
    if($result){

        $_SESSION['success_message'] = 'The addition of the Vendor was Successful';
