...
$qry = "SELECT * FROM `users` Where `role` = 3";
...
if(isset($_POST['submit'])){
    ...
    if($res) {
        $_SESSION['errors']['general'] = 'Staff IS INACTIVE SUCCESSFULLY';
...
if($_POST['update'] == 1){
    ...
    if($res){
        ...
        $_SESSION['success_message'] = 'Staff IS ACTIVE SUCCESSFULLY';
        header('Location: staffList.php');
        exit();
...
<?php require_once('mainFile/header.php'); ?>
    ...
    <section class="admin">
        <div class="dashboard">
            <div class="heading">
                <h2>Staff List</h2><a href="staffAdd.php" class="btn">Add Staff</a>
            </div>
