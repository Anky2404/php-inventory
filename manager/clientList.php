...
$qry = "SELECT * FROM `users` WHERE `role` = 2";
...
if(isset($_POST['submit'])){
    ...
    if($res){
        ...
        $_SESSION['errors']['general'] = 'CLIENT STATUS IS INACTIVE SUCCESSFULLY';
...
if($_POST['update'] == 1){
    ...
    if($res){
        ...
        $_SESSION['success_message'] = 'CLIENT STATUS IS ACTIVE SUCCESSFULLY';
        header('Location: clientList.php');
        exit();
